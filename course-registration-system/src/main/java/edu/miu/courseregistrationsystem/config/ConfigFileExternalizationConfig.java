package edu.miu.courseregistrationsystem.config;
...
public class ConfigFileExternalizationConfig {
    ...
    private static final String DOSSIER_CONFIG = ".registration-system" + File.separator + "conf";

    private ConfigFileExternalizationConfig() {
